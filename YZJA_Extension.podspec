...
Pod::Spec.new do |s|
  ...
  s.name         = "YZJA_Extension"
  s.version      = "1"
  s.summary      = "YZJA_Extension."
  ...
  s.source       = { :git => "https://github.com/YZJMediator/YZJA.git", :tag => "Extension-"+s.version.to_s }
  ...
  s.source_files  = "YZJA/YZJA_Category/**/*.{h,m}"
